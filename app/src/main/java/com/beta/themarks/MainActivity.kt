...
import com.beta.themarks.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val login = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){
        if(it.resultCode == Activity.RESULT_OK){
            ...
            try {
                ...
                Toast.makeText(applicationContext, getString(R.string.main_signin_fail), Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signin.setOnClickListener {
            if(num==1){
                ...
                Toast.makeText(this@MainActivity, getString(R.string.permission_request), Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun updateUI(currentuser: FirebaseUser?){
        if(currentuser != null){
            val main = Intent(this, SubMainActivity::class.java)
            startActivity(main)
            finish()
        }
    }
